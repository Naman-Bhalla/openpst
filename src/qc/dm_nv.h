...
enum DIAG_RTRE_MODE {
    RTRE_MODE_RUIM_ONLY = 0x00,
    RTRE_MODE_NV_ONLY   = 0x01,
    RTRE_MODE_RUIM_PREF = 0x02,
    RTRE_MODE_GSM_1X    = 0x03
};

enum DIAG_PREF_MODE {
    PREF_MODE_AMPS                = 0x03, // 3
    PREF_MODE_AMPS_CDMA           = 0x02, // 2
    PREF_MODE_AUTOMATIC           = 0x04, // 4
    PREF_MODE_CDMA_AMPS           = 0x00, // 0
    PREF_MODE_CDMA_AMPS_HDR       = 0x14, // 20
    PREF_MODE_CDMA_AMPS_HDR_WLAN  = 0x1B, // 27
    PREF_MODE_CDMA_AMPS_WLAN      = 0x1C, // 28
    PREF_MODE_CDMA_GSM_WCDMA      = 0x33, // 51
    PREF_MODE_CDMA_HDR            = 0x13, // 19
    PREF_MODE_CDMA_HDR_GSM_WCDMA  = 0x34, // 52
    PREF_MODE_CDMA_HDR_WLAN       = 0x17, // 23
    PREF_MODE_CDMA_IS2000         = 0x09, // 9
    PREF_MODE_CDMA_IS95           = 0x01, // 1
    PREF_MODE_CDMA_WLAN           = 0x15, // 21
    PREF_MODE_CDMAxAMPS           = 0x0B, // 11
    PREF_MODE_DIGITAL             = 0x12, // 18
    PREF_MODE_EMERGENCY           = 0x05, // 5
    PREF_MODE_GPS                 = 0x0C, // 12
    PREF_MODE_GSM_GPRS_EDGE       = 0x0D, // 13
    PREF_MODE_GSM_WCDMA           = 0x11, // 17
    PREF_MODE_GSM_WCDMA_WLAN      = 0x1A, // 26
    PREF_MODE_GSM_WLAN            = 0x18, // 24
    PREF_MODE_HDR                 = 0x0A, // 10
    PREF_MODE_HDR_OFF             = 0x10, // 16
    PREF_MODE_HDR_WLAN            = 0x16, // 22
    PREF_MODE_HDR_WLAN_OFF        = 0x1D, // 29
    PREF_MODE_HOME                = 0x06, // 6
    PREF_MODE_LTE                 = 0x1E, // 30
    PREF_MODE_LTE_CDMA            = 0x20, // 32
    PREF_MODE_LTE_CDMA_GSM        = 0x25, // 37
    PREF_MODE_LTE_CDMA_GSM_WLAN   = 0x2E, // 46
    PREF_MODE_LTE_CDMA_HDR        = 0x24, // 36
    PREF_MODE_LTE_CDMA_HDR_WLAN   = 0x2D, // 45
    PREF_MODE_LTE_CDMA_WCDMA      = 0x26, // 38
    PREF_MODE_LTE_CDMA_WCDMA_WLAN = 0x2F, // 47
    PREF_MODE_LTE_CDMA_WLAN       = 0x29, // 41
    PREF_MODE_LTE_GSM             = 0x22, // 34
    PREF_MODE_LTE_GSM_WCDMA       = 0x1F, // 31
    PREF_MODE_LTE_GSM_WLAN        = 0x2B, // 43
    PREF_MODE_LTE_HDR             = 0x21, // 33
    PREF_MODE_LTE_HDR_GSM         = 0x27, // 39
    PREF_MODE_LTE_HDR_GSM_WLAN    = 0x30, // 48
    PREF_MODE_LTE_HDR_WCDMA       = 0x28, // 40
    PREF_MODE_LTE_HDR_WCDMA_WLAN  = 0x31, // 49
    PREF_MODE_LTE_HDR_WLAN        = 0x2A, // 42
    PREF_MODE_LTE_WCDMA           = 0x23, // 35
    PREF_MODE_LTE_WCDMA_WLAN      = 0x2C, // 44
    PREF_MODE_WCDMA_HSDPA         = 0x0E, // 14
    PREF_MODE_WCDMA_WLAN          = 0x19, // 25
    PREF_MODE_WLAN                = 0x0F, // 15
    PREF_MODE_WLAN_OFF            = 0x32  // 50
};

enum DIAG_PREF_SERV {
    PREF_SERV_SYSTEM_A  = 0x00,
    PREF_SERV_SYSTEM_AB = 0x01,
    PREF_SERV_SYSTEM_B  = 0x02,
    PREF_SERV_SYSTEM_BA = 0x03,
    PREF_SERV_HOME_ONLY = 0x04,
    PREF_SERV_HOME_PREF = 0x05
};

enum DIAG_SYSTEM_PREF {
    SYSTEM_PREF_SYSTEM_A  = 0x00,
    SYSTEM_PREF_SYSTEM_B  = 0x01,
    SYSTEM_PREF_HOME_ONLY = 0x02,
    SYSTEM_PREF_HOME_PREF = 0x03
};

enum DIAG_ROAM_PREF {
    ROAM_PREF_HOME       = 0x01,
    ROAM_PREF_AFFILIATED = 0x03,
    ROAM_PREF_AUTOMATIC  = 0xFF,
    ROAM_PREF_STATIC     = 0x100,
};

enum DIAG_HYBRID_PREF {
    HYBRID_PREF_DISABLE = 0x00,
    HYBRID_PREF_ENABLE  = 0x01,
    HYBRID_PREF_FACTORY = 0x02
};

enum DIAG_HDR_SCP_FORCE_AT_CONFIG {
    AT_CONFIG_REV_0_ONLY      = 0x00,
    AT_CONFIG_REV_A_MFPA      = 0x01,
    AT_CONFIG_REV_A_MFPA_EMPA = 0x02,
    AT_CONFIG_REV_B_MFPA      = 0x03,
    AT_CONFIG_REV_A_EHRPD     = 0x04,
    AT_CONFIG_REV_B_EHRPD     = 0x05
};

enum DIAG_HDR_SCP_FORCE_REL0_CONFIG {
    REL0_CONFIG_REV_A = 0x00,
    REL0_CONFIG_REV_0 = 0x01
};

enum DIAG_DS_MIP_RETRIES {
    DS_MIP_RETRIES_1000MS = 0x00,
    DS_MIP_RETRIES_1250MS = 0x01,
    DS_MIP_RETRIES_1500MS = 0x02,
    DS_MIP_RETRIES_1750MS = 0x03,
    DS_MIP_RETRIES_2000MS = 0x04
};

enum DIAG_DS_QCMIP {
    DS_QCMIP_SIMPLE_IP      = 0x00,
    DS_QCMIP_PREF_MOBILE_IP = 0x01,
    DS_QCMIP_MOBILE_IP      = 0x02
};
